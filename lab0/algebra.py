...
def decode_sumprod(lst):
    ...
    return retVal
val = ['Product', 2, ['Sum', 3, 4]]
arg = decode_sumprod(val)
print 'input after decode: ', arg
print 'output:', simplify_if_possible( arg )
print 'output after decode:', encode_sumprod(simplify_if_possible( arg ))
