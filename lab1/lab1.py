...
# family_rules.
family_rules = [IF((OR('male (?x)','female (?x)')), THEN('Equality (?x) (?x)')),
                ...
                IF( AND('parent (?x) (?y)', 'parent (?x) (?z)','male (?y)',NOT('Equality (?y) (?z)')), THEN('brother (?y) (?z)')),
                IF( AND('parent (?x) (?y)', 'parent (?x) (?z)','female (?y)',NOT('Equality (?y) (?z)')), THEN('sister (?y) (?z)')),
                IF( AND('parent (?x) (?y)', 'parent (?x) (?z)',NOT('Equality (?y) (?z)'),'parent (?y) (?m)',
                        'parent (?z) (?n)' ,NOT('Equality (?m) (?n)')), THEN('cousin (?m) (?n)')),
